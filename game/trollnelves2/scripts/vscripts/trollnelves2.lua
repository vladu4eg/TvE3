...
function InitializeBadHero(hero)
	...
	Timers:CreateTimer(function()
		...
		if hero:IsAlive() then
			AddFOWViewer(hero:GetTeamNumber(), hero:GetAbsOrigin(), 350, 0.1, false)
		end
		return 0.1
	end)
	hero:SetStashEnabled(false)
...
hero.buildings["troll_hut_5"] = {startedConstructionCount = 0, completedConstructionCount = 0}
hero.buildings["troll_hut_6"] = {startedConstructionCount = 0, completedConstructionCount = 0}
hero.buildings["troll_hut_7"] = {startedConstructionCount = 0, completedConstructionCount = 0}
