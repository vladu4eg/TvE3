...
function moon_glaive_start_create_dummy(keys)
  ...
  dummy:AddAbility("luna_moon_glaive2_dummy_datadriven")
  local dummy_ability = dummy:FindAbilityByName("luna_moon_glaive2_dummy_datadriven")
  dummy_ability:ApplyDataDrivenModifier(caster, dummy, "modifier_moon_glaive2_dummy_unit", {})

  -- Ability variables
  dummy_ability.damage = 900100
  ...
  dummy_ability.dmgMultiplier = 0.2
  dummy_ability.original_ability = ability

  dummy_ability.particle_name = "particles/units/heroes/hero_luna/luna_base_attack.vpcf"
