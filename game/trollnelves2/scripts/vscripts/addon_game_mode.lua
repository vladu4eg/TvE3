...
function Precache( context )
	...
	PrecacheResource("model", "models/items/drow/frostfeather_huntress_weapon/frostfeather_huntress_weapon.vmdl", context)
    PrecacheResource("model", "models/items/drow/frostfeather_huntress_head/frostfeather_huntress_head.vmdl", context)
    ...
    PrecacheResource("model", "models/items/drow/frostfeather_huntress_back/frostfeather_huntress_back.vmdl", context)       
   ...
   -- PrecacheResource("model", "models/items/windrunner/ti6_windranger_shoulder/ti6_windranger_shoulder.vmdl", context)
    ...
    PrecacheResource("model", "models/items/vengefulspirit/fallenprincess_shoulders/fallenprincess_shoulders.vmdl", context)
    PrecacheResource("model", "models/items/nevermore/diabolical_fiend_arms/diabolical_fiend_arms.vmdl", context)
    PrecacheResource("model", "models/items/nevermore/diabolical_fiend_head/diabolical_fiend_head.vmdl", context)
    ...
    PrecacheResource("model", "models/items/medusa/dotaplus_medusa_body/dotaplus_medusa_body.vmdl", context)
	PrecacheResource("model", "models/items/medusa/dotaplus_medusa_tail/dotaplus_medusa_tail.vmdl", context)
