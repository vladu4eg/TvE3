...
function modifier_building:GetModifierDisableTurning()
  return self.disable_turning or 0
end
...
function modifier_building:CheckState()
  return { [MODIFIER_STATE_MAGIC_IMMUNE] = self.magic_immune or false,
          [MODIFIER_STATE_SPECIALLY_DENIABLE] = self.deniable or false, --add setting in building_settings.kv
